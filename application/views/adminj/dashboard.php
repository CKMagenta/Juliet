...
<html class="no-js">
    ...
    <head>
        ...
        <link href="<?php echo base_url("static") ?>/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">
        <link href="<?php echo base_url("static") ?>/vendors/easypiechart/jquery.easy-pie-chart.css" rel="stylesheet" media="screen">
        <link href="<?php echo base_url("static") ?>/assets/styles.css" rel="stylesheet" media="screen">
        <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
        <script src="<?php echo base_url("static") ?>/vendors/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
    ...
    <body>
        ...
        <script src="<?php echo base_url("static") ?>/vendors/easypiechart/jquery.easy-pie-chart.js"></script>
        <script src="<?php echo base_url("static") ?>/assets/scripts.js"></script>
        <script>
        $(function() {
            // Easy pie charts
